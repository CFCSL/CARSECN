...
if uploaded_file is not None:
	...
	for k in _tables:
		st.write(k)
		_tables[k]=st.experimental_data_editor(_tables[k])
		#st.write(_tables[k])
...
path=os.getcwd()+'/Output_files/Multi_CARSEC'
...
if uploaded_file is not None:
	CS.excel_to_CARSEC(load_path=uploaded_file,export_path=path+'/CS_Multi_')
